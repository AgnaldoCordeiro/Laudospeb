    ...
    return (
        ...
        <div className="container-fluid text-black" >
            <div className="container">
                <div className="row">
                    <div className="col">
                        <img className="pb-3" src="/inspelaudo.png" alt="Inspeção e laudo" width="350" height="250"/>
                    ...
                    <div className="col">
                        <img className="pb-3" src="/manutencao.png" alt="Manutenção" width="350" height="250"/>
                    ...
                    <div className="col">
                    <img className="pb-3" src="/projetos.png" alt="Projetos" width="350" height="250"/>
